...
def getCipherKey():
    ...
    return int(shiftAmount)  # Convert input to integer
...
def encryptMessage(message, cipherKey, alphabet):
    ...
    for currentCharacter in uppercaseMessage:
        if currentCharacter in alphabet:  # Encrypt only alphabetic characters
...
def decryptMessage(message, cipherKey, alphabet):
    return encryptMessage(message, -cipherKey, alphabet)  # Decrypt by reversing the cipher key
